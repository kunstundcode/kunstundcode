...
app.use(session({
  secret: process.env.SESSION_SECRET || 'irongenerator', // TODO: Change Session Secret
  resave: true,
...
app.use('/api/codekuenste', require('./routes/codekuenste'))
app.use('/api/userarts', require('./routes/userarts'))
